...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($sum >= "50") {
        echo "<h1>ดีใจด้วย คุณสอบผ่าน</h1><br>";
      } else {
    ...
    echo "ยินดีด้วย คุณได้เกรด C";
  } elseif ($sum >= "50") {
    echo "ยินดีด้วย คุณได้เกรด D";
  } else {
    echo "เสียใจด้วย คุณได้เกรด E";
  
  }
echo "<div class='alert alert-success'>
<strong>คำนวณเสร็จแล้ว!</strong> ผลคะแนนที่ได้ดังนี้ครับ
</div>";
  }
  ?>
